...
export default function EditSkillModal({ visible, onClose, skill, onSave, mode }: EditSkillModalProps) {
  ...
  const handleSave = () => {
    if (!formData.name.trim()) {
      Alert.alert('ข้อผิดพลาด', 'กรุณากรอกชื่อสกิล');
      return;
    }
    onSave(formData);
    onClose();
      ...
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          <View style={styles.header}>
            <Text style={styles.title}>{mode === 'create' ? 'สร้างสกิลใหม่' : 'แก้ไขสกิล'}</Text>
          ...
          <ScrollView style={styles.scrollContainer}>
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput
                ...
                placeholder="กรอก Icon ID"
              />
            </View>

            <View style={styles.row}>
              <View style={[styles.formGroup, styles.halfWidth]}>
                <Text style={styles.label}>ประเภทสกิล</Text>
                <View style={styles.switchContainer}>
                  ...
                  >
                    <Text style={[styles.switchButtonText, formData.skill_type === 'active' && styles.switchButtonTextActive]}>ใช้งาน</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                  ...
                  >
                    <Text style={[styles.switchButtonText, formData.skill_type === 'passive' && styles.switchButtonTextActive]}>พาสซีฟ</Text>
                  </TouchableOpacity>
                </View>
              </View>

              <View style={[styles.formGroup, styles.halfWidth]}>
                <Text style={styles.label}>ธาตุธาตุ</Text>
            ...
            <View style={styles.section}>
              <Text style={styles.sectionTitle}>ความต้องการ</Text>
            </View>

            <View style={styles.formGroup}>
              <Text style={styles.label}>เลเวลที่ต้องการ</Text>
              <TextInput
                style={styles.input}
            ...
            <View style={styles.row}>
              <View style={[styles.formGroup, styles.halfWidth]}>
                <Text style={styles.label}>ค่า MP</Text>
                <TextInput
                  style={styles.input}
              ...
              <View style={[styles.formGroup, styles.halfWidth]}>
                <Text style={styles.label}>คูลด (วินาที)</Text>
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.row}>
              <View style={[styles.formGroup, styles.halfWidth]}>
                <Text style={styles.label}>เวลาใช้ (วินาที)</Text>
                <TextInput
                  style={styles.input}
              ...
              <View style={[styles.formGroup, styles.halfWidth]}>
                <Text style={styles.label}>ระยะ</Text>
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.formGroup}>
              <Text style={styles.label}>พื้นที่ผลกระทบ</Text>
              <TextInput
                style={styles.input}
            ...
            <View style={styles.section}>
              <Text style={styles.sectionTitle}>ผลกระทบ</Text>
            </View>

            {formData.effects.map((effect, index) => (
              <View key={index} style={styles.effectItem}>
                <Text style={styles.effectLabel}>ผลกระทบ {index + 1}</Text>
                ...
                <View style={styles.row}>
                  <View style={[styles.formGroup, styles.halfWidth]}>
                    <Text style={styles.label}>ค่า</Text>
                    <TextInput
                      style={styles.input}
                  ...
                  <View style={[styles.formGroup, styles.halfWidth]}>
                    <Text style={styles.label}>ระยะเวลา (วินาที)</Text>
                    <TextInput
                      style={styles.input}
                ...
                >
                  <Text style={styles.removeButtonText}>ลบผลกระทบ</Text>
                </TouchableOpacity>
              </View>
            ))}

            <TouchableOpacity style={styles.addButton} onPress={addEffect}>
              <Text style={styles.addButtonText}>+ เพิ่มผลกระทบ</Text>
            </TouchableOpacity>

            <View style={styles.section}>
              <Text style={styles.sectionTitle}>เรียนได้โดย</Text>
            </View>

            {formData.learnable_by.map((role, index) => (
              <View key={index} style={styles.learnableItem}>
                <Text style={styles.learnableLabel}>บทบาท {index + 1}</Text>
                <TextInput
                  style={styles.input}
                  value={role}
            ...
            <TouchableOpacity style={styles.addButton} onPress={addLearnableBy}>
              <Text style={styles.addButtonText}>+ เพิ่มบทบาท</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.saveButton} onPress={handleSave}>
              <Text style={styles.saveButtonText}>บันทึกสกิล</Text>
            </TouchableOpacity>
          </ScrollView>
        </View>
      </View>
